...
public class PrivateObjectiveCardTest {
    ...
    public void getPointsTest() {
        ...
        assertEquals(21, new ShadesOfGreen().getPoints(window));
        assertEquals(10, new ShadesOfBlue().getPoints(window));
        assertEquals(13, new ShadesOfPurple().getPoints(window));
        assertEquals(6, new ShadesOfRed().getPoints(window));
        assertEquals(12, new ShadesOfYellow().getPoints(window));
    }
}